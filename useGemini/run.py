...
# Example usage
url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=xAIzaSyBJIsHjuoc_sgUug3yOQwxm_2274hZdp1Qx"  # Example API endpoint
data = {
    "contents": [{
        "parts":[{"text": "Hello"}]
    }]
